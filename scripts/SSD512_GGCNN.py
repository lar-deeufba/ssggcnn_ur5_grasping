...
class Server:
    def __init__(self):
        self.depth_ssd512 = None
        self.depth_raw = None

    def depth_ssd512_callback(self, msg):
        # "Store" message received.
        self.depth_message_ssd512 = msg
        self.depth_callback()
    ...
    def depth_callback(self):
        ...
        with TimeIt('Publish'):
            ...
            grasp_img.header = self.depth_message_ssd512.header
            grasp_pub.publish(grasp_img)

            grasp_img_plain = bridge.cv2_to_imgmsg(grasp_img_plain, 'bgr8')
            grasp_img_plain.header = self.depth_message_ssd512.header
